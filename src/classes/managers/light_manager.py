...
class LightManager:
    ...
    def draw_shader(self, light_sources: list[tuple[int, int, int]], walls: list[tuple[int, int, int, int]]):
        lights = list(chain.from_iterable(light_sources)) + [0, 0, 0] * (128 - len(light_sources))
